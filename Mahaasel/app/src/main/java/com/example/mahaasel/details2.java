    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buy1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(details2.this, "add to cart", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(details2.this,abdly1.class);
                startActivity(i);
            }
        });
        ...
        buy2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(details2.this, "add to cart", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(details2.this,abdly2.class);
                startActivity(i);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (drawerItem.getIdentifier() == 1) {
                            Intent i = new Intent(details2.this, Page4.class);
                            startActivity(i);
                        }
                        if (drawerItem.getIdentifier() == 2){
                            Intent i2= new Intent(details2.this, Page6.class);
                            startActivity(i2);
                        }
                        if (drawerItem.getIdentifier() == 3) {
                            Intent i3 = new Intent(details2.this, Page5.class);
                            startActivity(i3);
                        }
                        if (drawerItem.getIdentifier() == 4) {
                            Intent i3 = new Intent(details2.this, Page1.class);
                            startActivity(i3);
                        }
                        return false;
                    }
